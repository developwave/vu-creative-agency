  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-gradient-overlay via-background/60 to-background" />
      </motion.div>
      ...
      <div className="absolute top-0 left-0 w-full">
        ...
        >
          <path
            d="M0,0 L1440,0 L1440,50 Q1080,100 720,50 Q360,0 0,50 L0,0 Z"
      ...
      >
        <div className="text-center max-w-4xl">
          ...
          >
            Transform your vision into reality with designs that captivate and
            convert
          </motion.p>
        </div>
      </motion.div>
      ...
      <div className="absolute bottom-0 left-0 w-full">
        ...
        >
          <path
            d="M0,100 L1440,100 L1440,50 Q1080,0 720,50 Q360,100 0,50 L0,100 Z"
            fill="hsl(var(--background))"
          />
        </svg>
      </div>
